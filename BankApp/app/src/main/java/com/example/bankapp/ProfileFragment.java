...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        arbuser.clear();
        Cursor result = LoginActivity.mydb.user_GetData(userid);
        while (result.moveToNext()){
            ...
            bankUser bkuser = new bankUser(name,email,contact,account,amount);
            arbuser.add(bkuser);
        }
        profilelist=view.findViewById(R.id.profilelistview);
        ProfileCustomAdapter homeCustomAdapter = new ProfileCustomAdapter(getActivity(),arbuser);
        profilelist.setAdapter(homeCustomAdapter);
        return view;
    }
}