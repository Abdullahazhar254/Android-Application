...
public class ReceiverCustomAdapter extends ArrayAdapter {
    Activity context;
    ArrayList<userTransaction> arrayList;

    public ReceiverCustomAdapter(@NonNull Activity context, ArrayList<userTransaction> arrayList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        account.setText(String.valueOf(usertrans.getSender()));
